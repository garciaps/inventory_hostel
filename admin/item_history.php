...
<div class="container-fluid navbar-navs" style="margin-top: 10px; padding:15px; height: 110vh;">
    ...
    <div class="panel panel-border" style="width:1100px; margin-left: 550px;" style="float: right; height:10px;">
               <div class="panel-heading" style="font-size: 20px;">
                ...
                $sql = "SELECT * FROM borrower_history WHERE item = :toolname";
                $stmt = $pdo->prepare($sql);
                $stmt->bindParam(':toolname', $toolname, PDO::PARAM_STR);
                $stmt->execute();
                ...
                ?> 
                    ...
                    <a class="btn pull-right" href="../admin/position.php" style="margin-bottom: 10px; color:rgb(255, 239, 218);">
                ...
                <table class="table table-bordered" id="dataTable" style="text-align: center;">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;">Anticipated Return Date</th>
